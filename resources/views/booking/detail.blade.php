    ...
    <div class="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                <h4 class="text-lg font-bold text-gray-900 mb-4">Fasilitas Kamar</h4>
                @php
                    $fasilitas = explode(',', $booking->kamar->typeKamar->fasilitas ?? '');
                @endphp
                    ...
                    @foreach($fasilitas as $facility)
                        @if(trim($facility))
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-gray-700">{{ trim($facility) }}</span>
                            </div>
                        @endif
                    @endforeach
                </div>
            ...
            <!-- Description -->
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                <h4 class="text-lg font-bold text-gray-900 mb-4">Deskripsi</h4>
                <p class="text-gray-700 text-sm leading-relaxed">
                    {{ $booking->kamar->typeKamar->deskripsi ?? 'Tidak ada deskripsi tersedia untuk kamar ini.' }}
                </p>
            </div>
        </div>
    </div>
